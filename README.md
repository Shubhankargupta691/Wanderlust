...
# Wanderlust Implementation

### In this we will see how to deploy an end to end three tier MERN stack application on EKS cluster.
#
...
|-------------------------|----------------------------------------------------|
| **Jenkins Master**      | [Install and configure Jenkins](#Jenkins)         |
| **eksctl**              | [Install eksctl](#EKS)                             |
| **ArgoCD**              | [Install and configure ArgoCD](#Argo)              |
| **Jenkins Worker Setup** | [Install and configure Jenkins Worker Node](#Jenkins-worker) |
| **OWASP Setup**         | [Install and configure OWASP](#Owasp)             |
| **SonarQube**           | [Install and configure SonarQube](#Sonar)         |
| **Email Notification Setup** | [Email notification setup](#Mail)         |
| **Monitoring**          | [Prometheus and Grafana setup using Helm charts](#Monitor) |
